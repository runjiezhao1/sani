      ...
      counter(0)
{
    ...
    nope.setSource(QUrl::fromLocalFile(":/forms/nope.wav"));
    incorrect.setSource(QUrl::fromLocalFile(":/forms/incorrect.wav"));
    doh.setSource(QUrl::fromLocalFile(":/forms/doh.wav"));
}
